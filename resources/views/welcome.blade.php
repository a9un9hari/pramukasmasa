	...
	<body>
		...
		<div class="wrapper">
				...
				<div class="container" id="home">
					...
					<div id="sidemenu" class="col-md-3 hidden-xs hidden-sm">
						...
						<ul class="menu">
							...
							<li>
                <span class="glyphicon glyphicon-question-sign"></span> About ABA 
              </li>
              </a>
              <!-- <a class="link" href="#live">
							<li><span class="icon-register"></span> Live Score</li>
              </a> -->
              <a class="link" href="#gallery">
 							  <li><span class="icon-gallery"></span> Gallery </li>
               </a>
               <!-- 
              <a class="link" href="#guestbook">
							<li><span class="fa fa-comments"></span> Guest Book </li>
							</a><a class="link" href="#gallery">
							<li><span class="icon-gallery"></span> Gallery </li>
							</a><a class="link" href="#scoring">
							<li><span class="icon-score"></span> Live Score </li>
					...
					<div id="livescore">
						<div class="col-md-9 col-sm-8 col-xs-12 left-box">
							<div class='embed-container'>
								<iframe src='https://www.youtube.com/embed/ODLDai15-OQ' frameborder='0' allowfullscreen></iframe>
							</div>
						</div>
					</div>
					<!-- / livescore -->
          ...
          <!-- <div class="col-md-8 col-md-push-2">
			...
			<!-- register -->
			<?php /*?>
			<div class="bg-bluesky pad-tb40" id="live">
			<div class="container">
				<div class="col-md-12 " align="center">
					<h1 class="title blue text-xlarge">Live Score</h1>


					<!-- Nav tabs -->
					<ul class="filter nav nav-tabs" role="tablist">
						<li class="active"><a href="#putra" role="tab" data-toggle="tab">Putra</a></li>
						<li><a href="#putri" role="tab" data-toggle="tab">Putri</a></li>
					</ul>

					<!-- Tab panes -->
					<div class="tab-content">
						<div class="tab-pane fade in active" id="putra">
				...
				<th>
                    ...
                    CTP
						...
						<div class="tab-pane fade" id="putri">
							<table class="table table-striped">
								<tr>
									<th>No Regu</th>
				<th>
      ...
      <?php /* ?>
			<!-- schedule -->
			<div class="bg-bluesky" id="scoring">
				<div class="container pad-tb40" align="center">
					<h1 class="title blue margin-none">Live Score</h1>
      ...
      <?php */ ?>
			...
			<div class="container" id="contact">
				...
				<div class="col-md-3">
					<p class="text-white">
							Kak Nikel Daffa<br/>
             				<a href="https://wa.me/6285601135244" target="_blank">085-601-135-244</a><br/>
						<a href="mailto:abhinaya-smasa@scout-1331.com">abhinaya-smasa@scout-1331.com</a><br/>
						<a href="https://www.instagram.com/pramukasmasa/" target="_blank">@pramukasmasa</a>
					</p>
				</div>
				<div class="col-md-4 pull-right">
						<a href="http://pramuka.or.id/" target="_blank" class="pull-right">
							<img src="assets/img/gerakan-pramuka.png">
						</a>
						<div class="clearfix"></div>
						<br>
					<p class=" text-white text-micro" align="right">
						&copy; Abhinaya Scout Competition 2018. All Right Reserved
					</p>
				</div>
			</div>
			</footer>
			...
			<nav>
				<ul>
					<a class="overlay-about" href="#about">
						<li><span class="glyphicon glyphicon-question-sign"></span> About ASC 2016 </li>
					</a>
					...
					<!-- <a class="overlay-schedule" href="#score">
						<li><span class="icon-score"></span> Live Score </li>
					</a> -->
